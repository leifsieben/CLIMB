...
WAVES = {
    ...
    "climb_v2_labeleff_v2_frac_e2e": "label-efficiency e2e arm, per-task fractions (B1p1) — CURRENT; frozen arms in analysis/rigor/label_efficiency_fractions_*.csv",
    "climb_v2_labeleff_v2":    "label-efficiency, absolute budgets — SUPERSEDED by _frac (capped on small tasks)",
