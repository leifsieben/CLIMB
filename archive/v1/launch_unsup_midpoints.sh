#!/usr/bin/env bash
# Launch the added unsupervised midpoint scaling runs.
set -euo pipefail
...
nohup /home/ec2-user/venvs/climb/bin/python scripts/launch_experiment_wave.py \
  ...
  --resume \
  --skip_existing \
  --worker_name unsup-midpoints \
  >> /home/ec2-user/artifacts/robust_matrix_logs/unsup_midpoints.log 2>&1 &

echo "Launched PID $!"
echo "Log: /home/ec2-user/artifacts/robust_matrix_logs/unsup_midpoints.log"
